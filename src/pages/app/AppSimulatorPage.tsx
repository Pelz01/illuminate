...
const AppSimulatorPage = () => {
  ...
  return (
    <AppLayout title="Simulator" subtitle="Model any STON.fi position before you commit capital.">
      <div className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
        <div className="glass-card rounded-3xl p-6 md:p-8 space-y-7">
          <div>
            <label className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground font-mono">Pool</label>
          ...
          <div>
            <label className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground font-mono">Deposit</label>
          ...
          <div>
            <div className="flex justify-between">
              <label className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground font-mono">Price change</label>
          ...
          <div>
            <div className="flex justify-between">
              <label className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground font-mono">Time horizon</label>
        ...
        <div className="relative">
          ...
          <div className="relative glass-card rounded-3xl p-6 md:p-10 h-full flex flex-col">
            <div className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground font-mono">Projected outcome</div>
...
export default AppSimulatorPage;
